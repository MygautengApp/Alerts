...
<div class="container" >
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid" style="background: #275937;">
			<div class="navbar-header">
				...
				<a class="navbar-brand" style="color: white;" href="#">Daily Utility System</a>
				<img src="images/parliament.png" style="padding-right:500px; position:absolute;height:80%;">
			</div>
			...
			<div class="collapse navbar-collapse" id="bs-example">
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a style="color: white;" href="dailyutility.php">View Daily Alerts</a></li>
				</ul>
			</div>
	  		...
	  		<div class="slider">
	  			<!-- <h1>Flickity - wrapAround</h1> -->
					...
					<div  >
						  ...
						  <div  >
						  	<img src="images/parliamenthouse.png">
